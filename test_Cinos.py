...
class TestAddDrink:
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("water", "lemon", 0, ["water with lemon"], 0, id="zero_price"),  
            pytest.param("", "", 1.50, [" with "], 1.50, id="empty_base_flavor"), 
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("water", "lemon", -1.00, ValueError, id="negative_price"), 
        ],
    )
...
class TestGetTotal:
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(0, 0, id="zero_integer_total"),  
        ],
    )
...
class TestGetReceipt:
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(["water with lemon"], 0, "Order Receipt:\n- water with lemon\nTotal: $0.00", id="single_drink_zero_total"),  
            pytest.param([], 10.5, "Order Receipt:\nTotal: $10.50", id="empty_order_non_zero_total"), 
        ],
    )
